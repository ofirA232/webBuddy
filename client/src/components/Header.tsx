...
const Header = () => {
  ...
  return (
    <header className="border-b border-[#333333] py-4 relative z-50">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center justify-end gap-6">
            <nav className="flex items-center gap-6">
              ...
              <a href="#projects" className="text-white text-sm font-medium hover:text-gray-300 transition-colors">Projects</a>
              <a href="#skills" className="text-white text-sm font-medium hover:text-gray-300 transition-colors">Skills</a>
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-16 inset-x-0 z-50 bg-black border-b border-[#333333] py-4">
